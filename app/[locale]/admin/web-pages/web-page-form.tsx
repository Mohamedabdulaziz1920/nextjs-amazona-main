...
const WebPageForm = ({
  ...
  const t = useTranslations('WebPageForm')
      ...
      >
        <div className='flex flex-col gap-5 md:flex-row'>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='w-full'>
                <FormLabel>{t('formLabels.slug')}</FormLabel>
                <FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='space-x-2 items-center'>
                ...
                <FormLabel>{t('formLabels.isPublished')}</FormLabel>
              </FormItem>
            )}
          />
        </div>
        <div>
          ...
          >
            {form.formState.isSubmitting
              ? t('submittingText')
              : `${type === 'Create' ? t('createButton') : t('updateButton')}`}
          </Button>
        </div>
      </form>
    </Form>
