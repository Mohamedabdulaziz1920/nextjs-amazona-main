...
```ts
// الحد الأدنى للسعر للتوصيل المجاني
...
// دالة لحساب تاريخ التوصيل والسعر
...
// إنشاء مخزن سلة التسوق مع ميزة الثبات
const useCartStore = create(
  persist<CartState>(
    ...
    {
      name: 'cart-store', // اسم التخزين المحلي
    }
  )
)
...
```tsx
// زر إضافة للسلة في بطاقة المنتج
const AddButton = () => (
